...
static const char *const yytname[] =
{
  ...
  "PRINT", "ID", "NUMBER", "'='", "$accept", "program", "statement", YY_NULLPTR
};
...
{
      11,     7,     8,     1,     2,     3,     4,     1,     2,     3,
       4,    13,     9,    10,    14,    15,    12,    16
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* statement: SET ID '=' NUMBER  */
#line 26 "parser.y"
                        {
          symbol_table[(yyvsp[-2].num) - 'a'] = (yyvsp[0].num);
          printf("Assigned %c = %d\n", (yyvsp[-2].num), (yyvsp[0].num));
      }
#line 1075 "parser.tab.c"
    break;

  case 5: /* statement: ADD ID ID  */
#line 30 "parser.y"
                {
...
#line 1091 "parser.tab.c"
  ...
  case 7: /* statement: PRINT ID  */
#line 36 "parser.y"
               {
          printf("Print %c = %d\n", (yyvsp[0].num), symbol_table[(yyvsp[0].num) - 'a']);
      }
